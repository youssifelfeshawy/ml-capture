...
parser = argparse.ArgumentParser(
    description="Capture live traffic and extract UNSW-NB15 features."
)
parser.add_argument(
    "--iface",
    type=str,
...
parser.add_argument(
    "--output",
    type=str,
    default="grok_output_features_for_UNSW-NB.csv",
    help="Output CSV file (default: grok_output_features_for_UNSW-NB.csv)",
)
